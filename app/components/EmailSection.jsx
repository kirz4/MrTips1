          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                required
                className="bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5"
                placeholder="Apenas mandando um oi"
              />
            </div>
            <div className="mb-6">
              <label
            ...
            <button
              type="submit"
              className="bg-gradient-to-br from-green-500 via-cyan-500 to-blue-500 hover:bg-neutral-900 text-white font-medium py-2.5 px-5 rounded-lg w-full"
            >
              Envie sua mensagem
            </button>
          </form>
